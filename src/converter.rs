...
pub trait CTypeConverter {
    ...
    fn function_name_to_c_name(&self, function: &Function, flavor: FunctionNameFlavor) -> String {
        match flavor {
            FunctionNameFlavor::RawFFIName => function.name().to_string(),
            FunctionNameFlavor::CPPMethodNameWithClass => function.name().to_upper_camel_case(),
            FunctionNameFlavor::CPPMethodNameWithoutClass(class) => function.name().replace(class, "").to_upper_camel_case(),
        }
    }
}
...
impl CTypeConverter for Converter {
    ...
    fn primitive_to_typename(&self, x: &PrimitiveType) -> String {
        match x {
            ...
            PrimitiveType::U8 => "unsigned char".to_string(),
            PrimitiveType::U16 => "unsigned short".to_string(),
            PrimitiveType::U32 => "unsigned int".to_string(),
            PrimitiveType::U64 => "unsigned long".to_string(),
            PrimitiveType::I8 => "char".to_string(),
